...
struct
  ...
  fun pp_inst2 (V.dup) = ("59","dup")
    ...
    | pp_inst2 (V.if_cmp(V.eq, (offset, _))) = ("9F " ^ s16(offset), "if_cmpeq " ^ s16dec(offset))
    | pp_inst2 (V.if_cmp(V.ne, (offset, _))) = ("A0 " ^ s16(offset), "if_cmpne " ^ s16dec(offset))
    | pp_inst2 (V.if_cmp(V.lt, (offset, _))) = ("A1 " ^ s16(offset), "if_icmplt " ^ s16dec(offset))
    | pp_inst2 (V.if_cmp(V.ge, (offset, _))) = ("A2 " ^ s16(offset), "if_icmpge " ^ s16dec(offset))
    | pp_inst2 (V.if_cmp(V.gt, (offset, _))) = ("A3 " ^ s16(offset), "if_icmpgt " ^ s16dec(offset))
    | pp_inst2 (V.if_cmp(V.le, (offset, _))) = ("A4 " ^ s16(offset), "if_icmple " ^ s16dec(offset))
