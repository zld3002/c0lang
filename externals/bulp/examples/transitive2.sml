...
[
  ...
  (Syntax.P("path", [Syntax.VAR("y"), Syntax.VAR("x")]),
   [
    Syntax.P("path'",[Syntax.VAR("x"),Syntax.VAR("y")])
   ]),
  (Syntax.P("path", [Syntax.VAR("x"), Syntax.VAR("y")]),
...
val sorted = Array.array(SIZE + 2, []) : int list Array.array;
...
(*McAllester.rem transit [Syntax.P ("edge", [Syntax.ICONST(5), Syntax.ICONST(6)])];
*)
