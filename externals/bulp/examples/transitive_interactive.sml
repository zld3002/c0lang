...
app (fn Syntax.P("path", [Syntax.ICONST(i),Syntax.ICONST(j)])
		=> Array.update(sorted, i, j :: (Array.sub (sorted, i)))) out;

Array.modify (ListMergeSort.sort op>) sorted;

Array.app (fn L => Utility.say (String.concatWith ", " (map Int.toString L))) sorted;

McAllester.rem transit [Syntax.P("edge", [Syntax.ICONST(SIZE div 2), Syntax.ICONST((SIZE div 2) + 1)])];
